...
void main()
{
    ...
    vs_out.vWorldNormal = mat3(matrices.modelMatrix) * inNormal;
    vs_out.vWorldTangent = mat3(matrices.modelMatrix) * inTangent;
    vs_out.vWorldBiTangent = mat3(matrices.modelMatrix) * inBiTangent;
