...
namespace glutil
{
	...
	{
        if (axis.x == 1.0f){
            m_tempCurrMatrixRotation.x = angDegCCW;
        }
        
        if (axis.y == 1.0f){
            m_tempCurrMatrixRotation.y = angDegCCW;
        }
        
        if (axis.z == 1.0f){
            m_tempCurrMatrixRotation.z = angDegCCW;
        }
        
        m_currMatrixRotation = GetRotationMatrix(m_tempCurrMatrixRotation);
