	...
	**/
	...
	public:
		...
		**/
        ...
        /**
         \retieve Model Matrix 
     
         **/
        const glm::mat4 &Model() const
        {
            return m_currMatrixTranslation * m_currMatrixRotation * m_currMatrixScale;
        }
    ...
    private:
        ...
        glm::mat4 m_currMatrixTranslation = glm::translate(glm::vec3(0.0f));
        glm::vec3 m_tempCurrMatrixRotation = glm::vec3(0.0f);
        glm::mat4 m_currMatrixRotation = GetRotationMatrix(m_tempCurrMatrixRotation);
        glm::mat4 m_currMatrixScale = glm::scale(glm::vec3(1.0f));
        
        glm::mat4 GetRotationMatrix(const glm::vec3 &rotation ) const {
